...
const DetailedForecast: React.FC<{arrayWithForecast: WeatherForecast[]}> = ({ arrayWithForecast }) => {
  ...
  return (
    <div className={styled.containerForecast}>
      ...
      <List sx={{ width: '100%', maxWidth: 360 }}>
        <ListItem>
            <img className={styled.detailed__image} src="/src/assets/weather/detailed/thermometer.svg" alt="Термометр" />
          <Divider />
        ...
        <Divider />
        <ListItem>
          <img className={styled.detailed__image} src="/src/assets/weather/detailed/wind.svg" alt="Ветер" />
        ...
        <Divider />
        <ListItem>
          <img className={styled.detailed__image} src="/src/assets/weather/detailed/drop.svg" alt="Влажность" />
        ...
        <Divider />
        <ListItem>
          <img className={styled.detailed__image} src="/src/assets/weather/detailed/sun.svg" alt="Видимость" />
